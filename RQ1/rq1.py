#!/usr/bin/env python3
"""
SATD Detection Script (ML Cohort)
=================================
This script processes the ML GitHub repositories to detect SATD.
"""
import csv
import json
import re
...
def main():
    # --- ML COHORT CONFIG ---
    repo_list_path = Path("/root/satd_detection/ml_159.txt").resolve()
